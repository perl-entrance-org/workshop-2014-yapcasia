...
- ｢Perl入学式 in YAPC::Asia｣がはじめてのPerl入学式という方へ
    ...
    - 講師ないしサポーターが適宜その疑問を解決します!
    - 練習問題についても, 分からない所や, ｢そもそも何をしたらいいのか...｣という場合, 遠慮せずにサポーターの力を借りて行きましょう!

___
## 諸注意とお願い
- Perl入学式は, ｢ただ聞いていたらOK｣という勉強会では**ありません**
- あくまで, ｢プログラミング言語に挑戦してみたい!｣, ｢Perlをもっと知りたい!｣等といった参加者の皆さんに, より良い学習環境と学習資料を提供しているに過ぎません
...
- せっかく同じ机に座った縁, 今日一緒にPerlを学ぶ仲間に自己紹介しましょう
...
- カリキュラム
    ...
    - Botの作成
    - モジュールを利用した機能拡張
- 2時間という制約上, どうしても時間が足りなくなる可能性があります
    - それでも, 説明を省略したりしてカリキュラムを完走する, ということは｢しません!｣
...
- 先ほどのコードを使って, ｢こんにちは｣と入力した時だけ, ｢こんにちは!｣と出力するようにしてみよう
    - ...実は次のページに解答例が書いてあります. どうしてもわからない! という方は, サポーターや周囲の方と一緒に見てみて下さい
